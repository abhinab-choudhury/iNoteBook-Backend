...
app.use('/api/v1/userInfo', require('./routes/authentication/userInfo')) // Endpoint for getting info for loged-in user.
...
app.use('/api/v1/addnote', require('./routes/notes/addnote')) // Endpoint to add data into database 
